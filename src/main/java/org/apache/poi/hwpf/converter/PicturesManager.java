...
public interface PicturesManager {
     ...
     * @param pictureType   detected picture type (may be {@link PictureType#UNKNOWN}
     * @param suggestedName suggested picture name (based on picture offset in file),
     *                      supposed to be unique
     * @param widthInches   display width in inches (scaled). May be useful for rendering
     *                      vector images (such as EMF or WMF)
     * @param heightInches  display height in inches (scaled). May be useful for rendering
     *                      vector images (such as EMF or WMF)
