...
public class HWMPFEMD5 {
  ...
  */
    ...
    public void getMD5StoreDigest(HWMPFEMD5 hwpf)
    {
    	 int i, j;
...
　　　　　 字节拷贝到output的outpos位置开始
  ...
  */
    ...
    public static void main(String args[]) throws UnsupportedEncodingException{
    	...
    	// String mm="=?UTF-8?B?54Of5Y+w5LiJ546v5Y6G5Y+y6Zeu6aKYLnppcA==?=";
  	  // System.out.println( new String(mm.getBytes("ISO8859-1"),"utf-8"));
    }
}