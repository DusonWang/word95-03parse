...
public final class SlideShow {
     ...
     * @param format the format of the picture. One of constans defined in the
    ...
    public HeadersFooters getNotesHeadersFooters() {
        ...
        if (ppt2007 && _notes.length > 0) {
            return new HeadersFooters(hdd, _notes[0], newRecord, true);
        }
        return new HeadersFooters(hdd, this, newRecord, ppt2007);
    }
     ...
     * @param progId OLE Programmatic Identifier, e.g.
