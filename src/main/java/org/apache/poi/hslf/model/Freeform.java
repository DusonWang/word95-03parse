...
public final class Freeform extends AutoShape {
    ...
    public GeneralPath getPath() {
        ...
        if (verticesProp == null)
            verticesProp = (EscherArrayProperty) getEscherProperty(opt, EscherProperties.GEOMETRY__VERTICES);
        ...
        if (segmentsProp == null)
            segmentsProp = (EscherArrayProperty) getEscherProperty(opt, EscherProperties.GEOMETRY__SEGMENTINFO);
